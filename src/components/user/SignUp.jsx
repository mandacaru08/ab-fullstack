                ...
                <Form>
                    <form onSubmit={handleSignUp}>
                        <InputsContainer>
                            ...
                            <Input 
                                isFocusedOrFilled={inputStatus.confirmPasswordIsFocused || user.confirmPassword !== ''}
                                isInputValid={inputStatus.isConfirmPasswordEmpty || inputStatus.confirmPasswordIsFocused}
                            >
                                <input 
                                    type='password' 
                                    value={user.confirmPassword} 
                                    onFocus={() => setInputStatus({...inputStatus, confirmPasswordIsFocused: true})}
                                    onBlur={() => setInputStatus({...inputStatus, confirmPasswordIsFocused: false})}
                                    onChange={(e) => setUser({...user, confirmPassword: e.target.value})}
                                />
                                <label>Confirm Password*</label>
                                <Icon onClick={() => setUser({...user, confirmPassword: ''})}>
                                    <IoIosCloseCircle/>
                                </Icon>
                            </Input>
                        </InputsContainer>
                        <Button type='submit' disabled={isButtonDisabled}>Registrar</Button>
                    </form>
                </Form>
            </FormContainer>
            <Register>
                <div>
                    ...
                    <button onClick={() => navigate('/sign-in')} >Entre agora</button>
                </div>
            </Register>
        </SignUpForm>
        </Container>
