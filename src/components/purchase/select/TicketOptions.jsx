...
export default function TicketOptions(){
    ...
    function calculateTravelDuration({departureTime, arrivalTime}){
        ...
        const totalHours = calculateTotalHours(ticketDepartureTime.hour, ticketArrivalTime.hour);
        const totalMinutes = calculateTotalMinutes(ticketDepartureTime.minute, ticketArrivalTime.minute);
                        ...
                        <TicketOption key={ticket.id}>
                            <TicketInformation>
                                <TimeAndChanges>
                                    ...
                                    <hr></hr>
                                    <Duration>
                                        <span>{calculateTravelDuration({departureTime: ticket.departureTime, arrivalTime: ticket.arrivalTime})},</span>
                                    </Duration>
                                    <Changes>
                                ...
                                <Boats>
                                    {
                                        ticket.boats.map((boat, index) => {
                                            return(
                                                <Boat key={boat} isChangeBoat={index !== 0}>{boat}</Boat>
                                            )
                                        })
                                    }
                                </Boats>
